...
export default function FAQ() {
  ...
  return (
    <section id="faq" className="relative py-20 px-4 overflow-hidden" style={{ background: "#FFFFFF" }}>
      ...
      <div className="absolute pointer-events-none hidden md:block" style={{
        ...
        border: "1.5px solid rgba(0,119,182,0.1)", borderRadius: 14,
            ...
            <div className="space-y-2">
              {faqs.map((faq, i) => (
                <motion.div
                  ...
                  style={{
                    background: openIndex === i ? "rgba(0,119,182,0.04)" : "#F0F9FF",
                    border: openIndex === i ? "1px solid rgba(0,119,182,0.2)" : "1px solid #e1eaf5",
                  }}
                >
                  <button
                  ...
                  >
                    ...
                    <motion.div
                      ...
                      style={{
                        borderColor: openIndex === i ? "rgba(0,119,182,0.4)" : "#e1eaf5",
                        background: openIndex === i ? "rgba(0,119,182,0.08)" : "transparent",
                      }}
                    >
                      <Plus
                        className="w-4 h-4"
                        style={{ color: openIndex === i ? "#0077B6" : "#4a6080" }}
                      />
                    </motion.div>
                  </button>
