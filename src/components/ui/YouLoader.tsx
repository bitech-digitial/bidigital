...
export default function YouLoader({ size = 64 }: { size?: number }) {
  return (
    <div style={{ display: "flex", alignItems: "center", margin: "0.25em 0" }}>
      {/* Gradients partagés (invisible) */}
      <svg height="0" width="0" viewBox="0 0 64 64" style={{ position: "absolute" }}>
        <defs>
          <linearGradient gradientUnits="userSpaceOnUse" y2="2" x2="0" y1="62" x1="0" id="yl-b">
            <stop stopColor="#973BED" />
            <stop stopColor="#007CFF" offset="1" />
          </linearGradient>
          <linearGradient gradientUnits="userSpaceOnUse" y2="0" x2="0" y1="64" x1="0" id="yl-c">
          ...
          <linearGradient gradientUnits="userSpaceOnUse" y2="2" x2="0" y1="62" x1="0" id="yl-d">
      ...
      {/* Y */}
      <svg fill="none" viewBox="0 0 64 64" height={size} width={size} style={{ display: "inline-block" }}>
        <path
